...
function problemB () {
  ...
  // const fs = require('fs');
  // const log = fs.readFile('poem-one/stanza-02.txt', function (err, buffer) {
  //   return buffer.toString();
  // });
  // setTimeout(function(){console.log('This is log', log);}, 5000);
...
function problemC () {
  ...
  promisifiedReadFile('poem-one/stanza-02.txt').then(function(stanza){
    magenta(stanza);
...
function problemD () {
  ...
  promisifiedReadFile('poem-one/stanza-06.txt')
  .then(function(stanza){
    magenta(stanza)
  }, function(err){
    console.error(err);
